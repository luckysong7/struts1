...
<div id="bbs">
	...
	<div id="bbsArticle_footer">
		<div id="leftFooter">
               ...
               onclick="javascript:location.href='<%=cp%>/board.do?method=update&num=${dto.num }&${params }';"/>
               <input type="hidden" name="method" value ="delete_ok"/>
               <input type="button" value=" 삭제 " class="btn2" 
               onclick="javascript:location.href='<%=cp%>/board.do?method=delete_ok&num=${dto.num }&${params }';"/>
		</div>
		<div id="rightFooter">
